...
class Loginadvokasia extends BaseController
{
    public function index(): string
    {
        return view('auth/loginadvokasia/loginadvokasia');
    }
     ...
     public function logout()
    {
        ...
        return redirect()->to(site_url('advokasia'));
    }
}
