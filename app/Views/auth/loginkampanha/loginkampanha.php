...
<head>
  ...
  <title>Login &mdash; kampanha & Treinamentu</title>
      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <h4 class="text-dark font-weight-normal">Bem Vindo <span class="font-weight-bold">Kampanha</span></h4>
            <p class="text-muted">Akun Ne'e So Kampanha Aliasan Nasional Combate Tabaku Mak Bele Tama, Se Mak Laos Kampanha ANCT-TL Labele Uja.</p>
            ...
            <?php endif; ?>
            <form method="POST" action="<?= base_url('processologinkampanhaacnt')?>" class="needs-validation" novalidate="">
              <?= csrf_field();?>
        ...
        <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" style="width:1000px;" data-background="<?= base_url()?>template/assets/img/sigaru/sigaru.jpg">
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-2">
                ...
                ?>
              <div class="mb-5 pb-3">
                <h1 style="color: gray;"><strong>Kampanha ANCT-TL</strong></h1>
