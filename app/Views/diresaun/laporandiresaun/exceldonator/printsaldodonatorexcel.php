    ...
    <div class="section-body">
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6">
                        <form class="form-inline" action="<?= base_url('printsaldodonator/filterexcel')?>" method="get">
                            <table>
                                <tbody>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <div class="form-group ml-1">
                                                <a href="<?= base_url('printsaldodonator/cetakexcel') ?>" target="_blank"
                    ...
                    <div class="col-lg-6">
                        <form class="form-inline" action="<?= base_url('printsaldodonator/excel')?>" method="get">
                            <table>
                                <tbody>
                                    <tr>
                                        <td>
