    ...
    <center>
        ...
        <table class="border-table">
            <thead>
                ...
                <?php
                $total=0; 
                $no=1; foreach($saldo as $osan): ?>
                    <tr>
                        <td align="center"><?= $no++;?></td>
                        <td align="center"><?= $osan->instituisaun?></td>
                        <td align="center">$ <?= number_format($osan->total_saldo, 2) ?></td>
                    </tr>
                <?php
                ...
                <tbody id="table1">
                    <tr>
                        ...
                        <td title="$ <?= number_format($total, 2)?>" align="center"><strong>$ <?= number_format($total, 2)?></strong></td>
                    </tr>
                </tbody>
        </table><br><br>
        <table class="nato">
