        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('channelyoutube')?>" method="post" autocomplete="off">
                     <?= csrf_field(); ?>
                     <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="link_coding" value="<?= old('link_coding')?>" 
                        ...
                        <div class="input-group">
                            ...
                            <textarea name="link_media" 
                            class="form-control phone-number <?=isset($errors['link_media']) ? 'is-invalid' : null ?>" 
                            placeholder="Link Media" cols="30" rows="10"><?= old('link_media')?></textarea>
                            <div class="invalid-feedback">
                        ...
                        <a href="<?= base_url('channelyoutube');?>" class="btn btn-info mb-3"><i class="fas fa-sharp fa-regular fa-backward"></i></a>
                        </div>
                    </div>
                    </form>
                </div>
