            ...
            <div class="card">
                ...
                <thead class="table-primary">
                    ...
                    <tr>
                        ...
                        <?php 
                        if ($sistema->horas_tama == '08:00' || $sistema->horas_tama == '08:01' || $sistema->horas_tama == '08:02' || $sistema->horas_tama == '08:03'
                        || $sistema->horas_tama == '08:04' || $sistema->horas_tama == '08:05' || $sistema->horas_tama == '08:06' || $sistema->horas_tama == '08:07'
                        || $sistema->horas_tama == '08:08' || $sistema->horas_tama == '08:09' || $sistema->horas_tama == '08:10' || $sistema->horas_tama == '08:11'
                        || $sistema->horas_tama == '08:12' || $sistema->horas_tama == '08:13' || $sistema->horas_tama == '08:14' || $sistema->horas_tama == '08:15'
                        || $sistema->horas_tama == '08:16' || $sistema->horas_tama == '08:17' || $sistema->horas_tama == '08:18' || $sistema->horas_tama == '08:19'
                        || $sistema->horas_tama == '08:20' || $sistema->horas_tama == '08:21' || $sistema->horas_tama == '08:22' || $sistema->horas_tama == '08:23'
                        || $sistema->horas_tama == '08:24' || $sistema->horas_tama == '08:25' || $sistema->horas_tama == '08:26' || $sistema->horas_tama == '08:27'
                        || $sistema->horas_tama == '08:28' || $sistema->horas_tama == '08:29' || $sistema->horas_tama == '08:30') {?>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><h6>Alpha</h6></td>
                            <td colspan="2"><h6><strong><?= $alpha;?></strong></h6></td>
                        </tr>
                    </tbody>
                    </table>
                    <?php }else{ ?>
