        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('salariodiresaunancttl/'. $salari->id_salario)?>" method="post" autocomplete="off">
                     <?= csrf_field(); ?>
                     <input type="hidden" name="_method" value="PATCH">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-text">
                                ...
                                <select name="naran_salario" id="naran_salario" class="form-control <?=isset($errors['naran_salario']) ? 'is-invalid' : null ?>">
                                    <option value="<?= $salari->naran_salario?>"><?= $salari->naran_kompleto_diresaun?></option>
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-text">
                                ...
                                <select name="saldo_ancttl" id="saldo_ancttl" class="form-control <?=isset($errors['saldo_ancttl']) ? 'is-invalid' : null ?>">
                                    <option value="<?= $salari->saldo_ancttl?>"><?= $salari->instituisaun?></option>    
                        ...
                        <div class="input-group">
                            ...
                            placeholder="Qty Saldo" value="<?= $salari->qty_saldo?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            placeholder="Freq Salario" value="<?= $salari->freq_salario?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            placeholder="" value="<?= $salari->data_salario?>">
                            <div class="invalid-feedback">
