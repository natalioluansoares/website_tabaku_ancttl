    ...
    <div class="section-body">
        ...
        <?php endif; ?>
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                    <a href="<?= site_url('saldodonatorancttl/newancttl');?>" 
                ...
                <thead>
                    <tr>
                        ...
                        <th>Descripsaun </th>
                        <th>Instituisaun </th>
                        <th style="width: 40%;">Saldo Apoia</th>
                        <th style="width: 40%;">Total Saldo</th>
                    ...
                    $no=1; foreach($donator as $osan): ?>
                        <tr>
                            ...
                            <td><?= $osan->naran_apoia ?></td>
                            <td><?= $osan->descripsaun_apoia ?></td>
