...
<?= $this->section('title'); ?>
<title>Detail Dasos narativa&mdash; ANCT-TL</title>
<?= $this->endSection() ?>
                ...
                <center>
                    <div class="row">
                        <div class="col-lg-6">
                           ...
                           <p><strong>(<?= helperDiresaun()->naran_kompleto_diresaun ?>)</strong></p>
                        </div><br>
                        <div class="col-lg-6">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        .$narativa->kode_narativa.'/'.$narativa->diresaun_narativa) ?>" class="btn btn-primary" title="Fila"><i class="fas fa-sharp fa-regular fa-backward"></i></a>
                                       <?php }else {?>
                                        <a href="<?= base_url('relatorionarativa/relatorionarativaancttl/'
                                        .$narativa->kode_narativa) ?>" class="btn btn-primary" title="Fila"><i class="fas fa-sharp fa-regular fa-backward"></i></a>
                                      <?php } ?>
