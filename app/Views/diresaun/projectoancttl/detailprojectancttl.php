                                ...
                                <tr>
                                    <td>
                                        <?php if (helperDiresaun()->regulamento_diresaun == 2) { ?>
                                            <a href="<?= base_url('projectancttl/detail/'.$projeito->diresaun) ?>" class="btn btn-primary" title="Fila">
                                            <i class="fas fa-sharp fa-regular fa-backward"></i></a>
                                            <a href="<?= base_url('projectancttl/download/'.$projeito->id_projeito) ?>" target="_blank" 
                                            title="Download Project" class="btn btn-dark"><i class="fas fa-download"></i></a>
                                            <?php } else {?>
                                                <a href="<?= base_url('projectancttl') ?>" class="btn btn-primary" title="Fila">
                                                <i class="fas fa-sharp fa-regular fa-backward"></i></a>
                                                <a href="<?= base_url('projectancttl/download/'.$projeito->id_projeito) ?>" target="_blank" 
                                                title="Download Project" class="btn btn-dark"><i class="fas fa-download"></i></a>
