...
<?= $this->section('title'); ?>
<title>Troka Dados Media&mdash; ANCT-TL</title>
<?= $this->endSection();?>
        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('mediaancttl/troka_media')?>" method="post" autocomplete="off" enctype="multipart/form-data">
                     <?= csrf_field(); ?>
                     ...
                     <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select name="lian" id="lian" class="form-control phone-number <?=isset($errors['lian']) ? 'is-invalid' : null ?>" >
                                <option value="<?=$media->lian?>"><?=$media->lian?></option>
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['naran_intervista']) ? 'is-invalid' : null ?>" cols="30"  rows="6" co><?= $media->naran_intervista?></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['topiko']) ? 'is-invalid' : null ?>" cols="30"  rows="6" co><?= $media->topiko?></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['descripsaun']) ? 'is-invalid' : null ?>"  rows="3"><?= $media->descripsaun ?></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['conteudo']) ? 'is-invalid' : null ?>" rows="9"><?= $media->conteudo?></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['link_video_youtube']) ? 'is-invalid' : null ?>" cols="30" rows="10"><?= $media->link_video_youtube?></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['link_youtube']) ? 'is-invalid' : null ?>" cols="30" rows="10"><?= $media->link_youtube?></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['link_facebook']) ? 'is-invalid' : null ?>" cols="30" rows="10"><?= $media->link_facebook?></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['link_tik_tok']) ? 'is-invalid' : null ?>" cols="30" rows="10"><?= $media->link_tik_tok?></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['fatin']) ? 'is-invalid' : null ?>" cols="30"  rows="6" co><?= $media->fatin?></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="invalid-feedbackfoto">
                            <img src="<?= base_url('uploads/fotoancttl/'. $media->foto)?>" alt="" style="width: 250px;">
                        </div>
                    </div>
                        <div class="form-group">
                        <label for="data">Data Intervista*</label>
                        <div class="input-group">
                            <input type="date" id="" name="data" value="<?= $media->data?>" 
                        ...
                        <a href="<?= base_url('mediaancttl/'.$media->lian);?>" class="btn btn-info mb-3"><i class="fas fa-sharp fa-regular fa-backward"></i></a>
                        </div>
                    </div>
                    </form>
                </div>
