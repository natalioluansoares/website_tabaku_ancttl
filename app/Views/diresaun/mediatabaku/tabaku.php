                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <?php if (helperDiresaun()->regulamento_diresaun == 6) { ?>
                                            <td>
                                                <a href="<?= base_url('tabakudiresaun/new') ?>" class="btn btn-primary" title="Aumenta Media"><i class="fas fa-plus"></i></a>
                                            </td>
                                       <?php }?>
                                    </tr>
                                </tbody>
        ...
        <div class="row">
            ...
            <article class="article article-style-c">
                ...
                <div class="article-title">
                    <h2><a href="<?= base_url('tabakudiresaun/detail/'.$me->id_tabaku) ?>" title="Detail Notisia" style="color: blue;"><?= $me->topiko?></a></h2>
                </div>
                    ...
                    <center>
                        <table>
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="<?= base_url('tabakudiresaun/troka/'.$me->id_tabaku) ?>" class="btn btn-success"><i class="fas fa-user-edit"></i></a>
                                        <form action="<?= site_url('tabakudiresaun/trokarelatorio/'.$me->id_tabaku)?>" method="post" autocomplete="off" 
