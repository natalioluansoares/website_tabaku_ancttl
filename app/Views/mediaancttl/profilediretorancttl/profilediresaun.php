...
<div class="container-fluid">  
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card m-b-30">
                <div class="card-body">
                    <form action="<?= base_url(lang('homemediaancttl.homeUrlProfileDiresaun'))?>" method="get" autocomplete="off" >
                        <table style="width: 100%;">
                            <thead>
                                <tr>
                                    <td>
    ...
    <div class="col-lg-6">
        <div class="card m-b-30" style="background-color: lightblue;">
            <div class="card-body">
                <small class="mt-0 "><strong><?= $mv->naran_kompleto_diresaun?></strong></small>
                <div class="media m-b-30">
                    <a class="image-popup-no-margins" href="<?= base_url('uploads/fotodiresaun/'.$mv->foto_diresaun)?>">
                        <img class="img-responsive rounded  mr-3" src="<?= base_url('uploads/fotodiresaun/'.$mv->foto_diresaun)?>" style="width:150px;" >
                        <p style="color: black;"><strong><?= lang('homemediaancttl.homeDay') ?> <b class="mr-2"></b>:</strong><?= $mv->data_profile_diresaun?></p>
                    </a>
                    <div class="media-body">
                        <strong><?= substr($mv->profile_diresaun, 0, 300) ?></strong>
                        <a href="<?= base_url(lang('homemediaancttl.homeUrlProfileDetailDiresaun').$mv->id_profile_diresaun)?>" style="color: blue;">
