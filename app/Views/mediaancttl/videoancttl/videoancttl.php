    ...
    <div class="col-lg-12">
            <div class="card" style="width: 100%;">
                <div class="carousel-item active">
                    <img class="d-block img-fluid" src="<?= base_url('assets')?>/ancttl/sigaru_7.jpg" alt="First slide"style="width: 100%; height:510px ;">
...
<div class="container-fluid">
    <h4 class="page-title" style="color: aliceblue;"><strong><i class="fas fa fa-video-camera mr-2"></i>Video Notisia</strong></h4>
    <div class="row">
        <div class="col-lg-6">
