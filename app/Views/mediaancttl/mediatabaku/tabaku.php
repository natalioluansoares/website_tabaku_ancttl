    ...
    <div class="col-lg-12">
            <div class="card" style="width: 100%;">
                <div class="carousel-item active">
                    <img class="d-block img-fluid" src="<?= base_url('assets')?>/ancttl/sigaru_3.jpg" alt="First slide"style="width: 100%; height:510px ;">
...
<div class="container-fluid">  
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card m-b-30">
                <div class="card-body">
                    <form action="<?= base_url(lang('homemediaancttl.homeUrlTabaku'))?>" method="get" autocomplete="off" >
                        <table style="width: 100%;">
                            <thead>
                                <tr>
                                    <td>
    ...
    <div class="col-lg-6">
        <div class="card m-b-30" style="background-color: lightblue;">
            <div class="card-body">
                <small class="mt-0 "><strong><?= $mv->fatin?></strong></small>
                ...
                <div class="media m-b-30">
                    <a class="image-popup-no-margins" href="<?= base_url('uploads/fototabaku/'.$mv->foto)?>">
                        ...
                        <p style="color: black;"><strong><?= lang('homemediaancttl.homeDay') ?> <b class="mr-2"></b>:</strong><?= $mv->data?></p>
                    </a>
