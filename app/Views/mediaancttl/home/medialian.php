    ...
    <div class="col-lg-12">
            <div class="card" style="width: 100%;">
                <div class="carousel-item active">
                    <img class="d-block img-fluid" src="<?= base_url('assets')?>/ancttl/sigaru_6.jpg" alt="First slide"style="width: 100%; height:510px ;">
...
<div class="container-fluid">  
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card m-b-30">
                <div class="card-body">
                    <form action="<?= base_url(lang('homemediaancttl.homeUrlMedia'))?>" method="get" autocomplete="off" >
                        <table style="width: 100%;">
                            <thead>
                                <tr>
                                    <td>
