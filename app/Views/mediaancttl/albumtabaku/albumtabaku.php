    ...
    <div class="col-lg-12">
            <div class="card" style="width: 100%;">
                <div class="carousel-item active">
                    <img class="d-block img-fluid" src="<?= base_url('assets')?>/ancttl/sigaru_4.jpg" alt="First slide"style="width: 100%; height:510px ;">
...
<div class="container-fluid">
    <h4 class="page-title"><strong><i class="mdi mdi-folder-image mr-2"></i><?= lang('homemediaancttl.homeAlbumTabaku')?></strong></h4>
    <div class="row">
        <div class="col-lg-6">
        ...
        <div class="col-lg-3">
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <!-- 21:9 aspect ratio -->
                    <a class="image-popup-no-margins" href="<?= base_url('uploads/foto_tabaku/'.$md->galeria)?>">
                        <img class="card-img img-fluid mb-2" src="<?= base_url('uploads/foto_tabaku/'.$md->galeria)?>">
                    </a>
                    <small><a href="<?= base_url(lang('homemediaancttl.homeUrlTabakuDetail'). $md->tabaku) ?>" title="<?= lang('homemediaancttl.homeMediaDetail'); ?>">
