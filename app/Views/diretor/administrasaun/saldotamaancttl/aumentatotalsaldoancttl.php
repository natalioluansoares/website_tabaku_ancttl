        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('totalsaldoancttl')?>" method="post" autocomplete="off">
                     <?= csrf_field(); ?>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="kode_osan" value="<?= old('kode_osan')?>" 
                            class="form-control phone-number <?=isset($errors['kode_osan']) ? 'is-invalid' : null ?>" 
                            placeholder="Kode Osan" autofocus>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="instituisaun" value="<?= old('instituisaun')?>" 
