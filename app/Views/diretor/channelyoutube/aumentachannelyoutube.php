        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('diretorchannelyoutube')?>" method="post" autocomplete="off">
                     <?= csrf_field(); ?>
                     <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <textarea name="link_style" 
                            class="form-control phone-number <?=isset($errors['link_style']) ? 'is-invalid' : null ?>" 
                            placeholder="Link Style" cols="30" rows="10"><?= old('link_style')?></textarea>
                            <div class="invalid-feedback">
