...
<?= $this->section('title'); ?>
<title>Aumenta Dados Regulamento&mdash; Sistema</title>
<?= $this->endSection();?>
        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('regulamentosistema')?>" method="post" autocomplete="off">
                     <?= csrf_field(); ?>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="regulamento" value="<?= old('regulamento')?>" 
