...
<?= $this->section('title'); ?>
<title>Dados Regulamento&mdash; Sistema</title>
<?= $this->endSection() ?>
            ...
            <div class="card">
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <td><a href="<?= site_url('regulamentosistema/'.$sistema->id_regulamento.'/edit') ?>" class="btn btn-success"><i class="fas fa-user-edit"></i></a></td>
                        <form action="<?= site_url('regulamentosistema/'.$sistema->id_regulamento)?>" method="post" autocomplete="off" 
