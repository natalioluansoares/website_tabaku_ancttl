        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('profilediretor')?>" method="post" autocomplete="off">
                     <?= csrf_field(); ?>
                     ...
                     <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="data_profile" value="<?= old('data_profile')?>" 
                        ...
                        <div class="input-group">
                            ...
                            placeholder="Profile" cols="30" rows="10"><?= old('profile')?></textarea>
                            <div class="invalid-feedback">
