                    ...
                    <center>
                        <table>
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="<?= base_url('diretormedia/troka/'.$me->id_media) ?>" class="btn btn-success"><i class="fas fa-user-edit"></i></a>
                                        <form action="<?= site_url('diretormedia/trokarelatorio/'.$me->id_media)?>" method="post" autocomplete="off" 
