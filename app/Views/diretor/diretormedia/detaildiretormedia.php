                    ...
                    <div class="col-12 col-sm-12 col-lg-12">
                      <div class="card-body">
                        <div class="gallery" >
                          ...
                          <div class="gallery-item" style="width: 240px; height:150px ;" data-image="<?= base_url('uploads/foto_anct_tl/'.$foto->galeria); ?>" data-title="Imagem "></div>
                          <?php endforeach;?>
                        </div>
                    </div>
                  </div>
                ...
                <div class="article-user">
                        <table>
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="<?= base_url('diretormedia/'.$media->lian) ?>" class="btn btn-primary" title="Fila">Fila</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
