...
<section class="section">
    ...
    <div class="section-body">
        ...
        <?php endif; ?>
        <a href="<?= base_url($lian);?>" class="btn btn-info mb-3">
        <i class="fas fa-sharp fa-regular fa-backward"></i></a>
        <a href="<?= base_url('diretormedia/temporario');?>" 
        ...
        <div class="row">
            ...
            <article class="article article-style-c">
                ...
                <div class="article-title">
                    <h2><a href="<?= base_url('diretormedia/'.$me->id_media) ?>" title="Detail Notisia" style="color: blue;"><?= $me->topiko?></a></h2>
                </div>
                    ...
                    <center>
                        <table>
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="<?= base_url('diretormedia/temporario/'.$me->id_media);?>" 
                                        class="btn" style="background-color: darkgrey;" title="Troka Dados Temporario"><i class="fa fa-solid fa-eraser"></i></a>
                                        <form action="<?= site_url('diretormedia/'.$me->id_media)?>" method="post" autocomplete="off" 
                                        onsubmit="return confirm('Ita Hakarak Hamos Dados ?')">
                                        <input type="hidden" name="_method" value="DELETE">
                                            <?= csrf_field(); ?>
                                            <!-- <input type="hidden" name="id_media" class="form-control" value="<?=$me->id_media?>"> -->
