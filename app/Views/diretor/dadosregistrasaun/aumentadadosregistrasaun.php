        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('akunancttl')?>" method="post" autocomplete="off" enctype="multipart/form-data">
                     <?= csrf_field(); ?>
                     <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="naran_kompleto_diresaun" value="<?= old('naran_kompleto_diresaun')?>" 
                        ...
                        <div class="form-group">
                            <label for="numero_whatsapp">Foto Diresaun *</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                <div class="input-group-text">
                                    <i class="fas fa-paper-plane"></i>
                                ...
                                <input type="file" name="foto_diresaun" id="numero_whatsapp" value="<?= old('foto_diresaun')?>" 
                                class="form-control phone-number <?=isset($errors['foto_diresaun']) ? 'is-invalid' : null ?>">
                                <div class="invalid-feedback">
                                    <?=isset($errors['foto_diresaun']) ?  $errors['foto_diresaun'] : null ?>
                                </div>
                            </div>
                        </div>
