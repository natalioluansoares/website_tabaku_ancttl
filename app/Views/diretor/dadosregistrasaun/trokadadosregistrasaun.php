        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('akunancttl/diresaun')?>" method="post" autocomplete="off" enctype="multipart/form-data">
                     <?= csrf_field(); ?>
                     <input type="hidden" name="id_diresaun" value="<?= $diresaun->id_diresaun?>">
                     <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="naran_kompleto_diresaun" value="<?=$diresaun->naran_kompleto_diresaun ?>" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select name="sexo" id="sexo" class="form-control <?=isset($errors['sexo']) ? 'is-invalid' : null ?>">
                                    <option value="<?=$diresaun->sexo ?>"><?=$diresaun->sexo ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select name="status_servisu" id="status_servisu" class="form-control <?=isset($errors['status_servisu']) ? 'is-invalid' : null ?>">
                                    <option value="<?=$diresaun->status_servisu ?>"><?=$diresaun->status_servisu ?></option>
                         ...
                         <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="fatin_moris" id="fatin_moris" value="<?= $diresaun->fatin_moris?>" 
                         ...
                         <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" name="loron_moris" id="loron_moris" value="<?= $diresaun->loron_moris?>" 
                         ...
                         <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" id="numero_eleitural" value="<?= $diresaun->email?>" 
                         ...
                         <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="numero_eleitural" id="numero_eleitural" value="<?=$diresaun->numero_eleitural?>" 
                         ...
                         <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="numero_whatsapp" id="numero_whatsapp" value="<?= $diresaun->numero_whatsapp?>" 
                         ...
                         <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="file" name="foto_diresaun" id="numero_whatsapp" value="" 
                            ...
                            <img alt="image" src="<?= base_url('uploads/fotodiresaun/'.$diresaun->foto_diresaun)?>" style="width: 130px;">
                        </div>
                        ...
                        <a href="<?= base_url('akunancttl');?>" title="Fila Fali Ba Sistema Diresaun" class="btn btn-info mb-3"><i class="fas fa-sharp fa-regular fa-backward"></i></a>
                        </div>
                    </div>
                    </form>
                </div>
