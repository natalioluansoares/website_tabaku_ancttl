        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('cartadiretorancttl')?>" method="post" autocomplete="off">
                     <?= csrf_field(); ?>
                     ...
                     <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select name="profisaun" id="profisaun" class="form-control <?=isset($errors['profisaun']) ? 'is-invalid' : null ?>">
                                <option value="">Hili Naran Diretor</option>
                     ...
                     <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="data_carta" value="<?= old('data_carta')?>" 
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="periode_carta" value="<?= old('periode_carta')?>" 
                        ...
                        <div class="input-group">
                            ...
                            placeholder="Carta Diretor" cols="30" rows="10"><?= old('carta')?></textarea>
                            <div class="invalid-feedback">
