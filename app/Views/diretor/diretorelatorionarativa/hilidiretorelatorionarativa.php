                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="dropdown">
                                ...
                                <?php foreach($regulamento as $sistema): ?>
                                    <li><a class="dropdown-item" href="<?= base_url('diretorelatorionarativa/relatorionarativaadministrasaun/40/'
                        ...
                        <div class="col-lg-6">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-dark"  style="height: 200px; width: 80%; overflow-y: scroll;">
                                <?php foreach($regulamento as $sistema): ?>
                                    <li><a class="dropdown-item" href="<?= base_url('diretorelatorionarativa/relatorionarativaadministrasaun/60/'
                                    .$sistema->id_regulamento)?>"><?= $sistema->regulamento?></a></li>
                                    <?php endforeach;?>
                                </ul>
                            </div>
