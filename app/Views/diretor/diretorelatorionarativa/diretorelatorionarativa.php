...
<section class="section">
    ...
    <div class="card mb-3">
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group ml-1">
                                                    <a href="<?= base_url('diretorelatorionarativa/hamos/'.$persen.'/'.$regulamento->id_regulamento);?>" 
        ...
        <a href="<?= base_url('diretorelatorionarativa');?>" 
        class="btn btn-info" title="Fila Fali Ba Pagina Primeiro"><i class="fas fa-sharp fa-regular fa-backward"></i></a><br><br>
        ...
        <div class="row">
            ...
            <article class="article article-style-c">
                ...
                <div class="article-title">
                    <a href="<?= base_url('diretorelatorionarativa/'.$me->id_narativa) ?>" title="Detail Notisia"><?= $me->topiko_narativa?></a>
                </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <a href="<?= base_url('diretorelatorionarativa/troka/'.$me->id_narativa) ?>" title="Troka Projeito" class="btn btn-success"><i class="fas fa-user-edit"></i></a>
                                            <form action="<?= site_url('diretorelatorionarativa/trokarelatorio/'.$me->id_narativa)?>" method="post" autocomplete="off" 
                                            ...
                                            <!-- <input type="hidden" name="_method" value="DELETE"> -->
                                                <?= csrf_field(); ?>
                                                <td><button type="submit" class="btn btn-danger"  title="Hamos Relatorio Narativa"><i class="fas fa-solid fa-trash"></i></button></td>
                                            </form>
                                        </td>
                                    </tr>
                                </tbody>
