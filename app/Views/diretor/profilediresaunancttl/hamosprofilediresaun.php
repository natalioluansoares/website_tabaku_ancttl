            ...
            <div class="card">
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <td><a href="<?= site_url('profilediresaundiretor/temporario/'.$sistema->id_profile_diresaun_ancttl) ?>" title="<?=$detail ?>" class="btn btn-dark"><i class="fa fa-regular fa-eraser"></i></a></td>
                        <form action="<?= site_url('profilediresaundiretor/hamos_hotu/'.$sistema->id_profile_diresaun)?>" method="post" autocomplete="off" 
