...
<section class="section">
    ...
    <div class="section-body">
            ...
            <div class="col-lg-6">
                <div class="card profile-widget">
                  ...
                  <div class="card-footer text-center pt-0">
                    ...
                    <form action="<?= site_url('akundiretor/temporario')?>" method="post" autocomplete="off" class="d-inline"
                        onsubmit="return confirm('Ita Boot Hakarak Hamos Dados ?')">
                            <?= csrf_field(); ?>
                            <!-- <input type="hidden" name="_method" value="DELETE"> -->
                            <input type="hidden" name="id_diretor" value="<?=$k->id_diretor?>">
                    ...
                    <form action="<?= site_url('akundiretor/hamos_dados/'.$k->id_diretor)?>" method="post" autocomplete="off" class="d-inline"
                        onsubmit="return confirm('Ita Boot Hakarak Hamos Dados ?')">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="_method" value="DELETE">
        ...
        <?php }else{ ?>
            ...
            Sei Mamuk</span>
            <p><br><a href="<?= base_url('akundiretor');?>" title="Fila Fali Ba Akun Diretor" class="btn btn-info">
              Fila Fali Ba Akun Diretor</a></p>
            </center>
        <?php } ?>
</section>
<?= $this->endSection();?>