        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('diretorprojectancttl/troka_projeito')?>" method="post" autocomplete="off" enctype="multipart/form-data">
                     <?= csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select name="diresaun" id="diresaun" class="form-control <?=isset($errors['diresaun']) ? 'is-invalid' : null ?>">
                                    <option value="<?= $project->diresaun ?>"><?= $project->regulamento ?></option>
