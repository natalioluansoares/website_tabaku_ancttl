...
<section class="section">
    ...
    <div class="section-body">
        ...
        <?php endif; ?>
        <a href="<?= base_url('diretorprojectancttl/detail/'.$regulamento->id_regulamento);?>" class="btn btn-info mb-3">
        <i class="fas fa-sharp fa-regular fa-backward"></i></a>
        <a href="<?= base_url('diretorprojectancttl/temporario');?>" 
                ...
                <center>
                    <table>
                        <tbody>
                            <tr>
                                <td>
                                    <a href="<?= base_url('diretorprojectancttl/temporario/'.$me->id_projeito);?>" 
                                    ...
                                    <form action="<?= site_url('diretorprojectancttl/hamos_hotu/'.$me->id_projeito)?>" method="post" autocomplete="off" 
