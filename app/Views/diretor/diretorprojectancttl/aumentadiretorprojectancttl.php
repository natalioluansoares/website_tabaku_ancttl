        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('diretorprojectancttl')?>" method="post" autocomplete="off" enctype="multipart/form-data">
                     <?= csrf_field(); ?>
                     <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['introdusaun']) ? 'is-invalid' : null ?>" value="<?= old('introdusaun')?>"  rows="3"></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['titulo_projeito']) ? 'is-invalid' : null ?>"
                             value="<?= old('titulo_projeito')?>"  rows="3"></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['objectivo_projeito']) ? 'is-invalid' : null ?>"
                             value="<?= old('objectivo_projeito')?>"  rows="3"></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            <textarea name="durasaun_projeito" id="duransaun_projeito" placeholder="Durante Projeito" class="form-control phone-number 
                            <?=isset($errors['durasaun_projeito']) ? 'is-invalid' : null ?>"
                             value="<?= old('durasaun_projeito')?>"  rows="3"></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['implementasaun_projeito']) ? 'is-invalid' : null ?>"
                             value="<?= old('implementasaun_projeito')?>"  rows="3"></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['benefisiariu_projeito']) ? 'is-invalid' : null ?>"
                             value="<?= old('benefisiariu_projeito')?>"  rows="3"></textarea>
                            <div class="invalid-feedback">
                                <?=isset($errors['implementasaun_projeito']) ?  $errors['implementasaun_projeito'] : null ?>
                            </div>
                        </div><br>
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" name="created" id="" value="<?= date('Y-m-d')?>" 
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['lian_maktaka']) ? 'is-invalid' : null ?>"
                             value="<?= old('lian_maktaka')?>"  rows="3"></textarea>
                            <div class="invalid-feedback">
                        ...
                        <a href="<?= base_url('diretorprojectancttl');?>" class="btn btn-info mb-3"><i class="fas fa-sharp fa-regular fa-backward"></i></a>
                        </div>
                    </div>
                    </form>
                </div>
