...
<?= $this->section('title'); ?>
<title>Troka Dados kode_the_union&mdash; Sistema</title>
<?= $this->endSection();?>
        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('kodenarativatheunion/'.$kodetheunion->id_kode_union)?>" method="post" autocomplete="off">
                     <?= csrf_field(); ?>
                     <input type="hidden" name="_method" value="PATCH">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="kode_the_union" value="<?= $kodetheunion->kode_the_union?>" 
