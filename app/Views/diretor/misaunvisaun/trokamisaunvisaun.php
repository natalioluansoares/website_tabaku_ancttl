        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('misaunvisaunancttl/'.$misaunvisaun->id_misaunvisaun)?>" method="post" autocomplete="off">
                     <?= csrf_field(); ?>
                     ...
                     <div class="form-group">
                        ...
                        <div class="input-group">
                            <select name="lingua_misaun_visaun" id="lingua_misaun_visaun" class="form-control <?=isset($errors['lingua_misaun_visaun']) ? 'is-invalid' : null ?>" >
                                <option value="<?= $misaunvisaun->lingua_misaun_visaun?>">
                                <?= $misaunvisaun->lingua_misaun_visaun?></option>
                     ...
                     <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            placeholder="Misaun" cols="30" rows="10"><?= $misaunvisaun->misaun?></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            placeholder="Visaun" cols="30" rows="10"><?= $misaunvisaun->visaun?></textarea>
                            <div class="invalid-feedback">
                        ...
                        <a href="<?= base_url('misaunvisaunancttl/lingua/'.$misaunvisaun->lingua_misaun_visaun);?>" class="btn btn-info mb-3"><i class="fas fa-sharp fa-regular fa-backward"></i></a>
                        </div>
                    </div>
                    </form>
                </div>
